...
exports.getTasks = exports.setAudio = exports.setTasksActive = exports.setTasksTotal = exports.setTasksItems = exports.setTasks = exports.setConfig = exports.getApplications = exports.getService = exports.createCredential = exports.setCredential = exports.setService = exports.setApplications = exports.setApplication = exports.resetAll = void 0;
...
var getService = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, operators_1.serviceOperator.get(constants_1.SUNO_SERVICE_ID)];
            case 2:
        ...
        switch (_d.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, operators_1.applicationOperator.getAll({
                        ...
                        service_id: constants_1.SUNO_SERVICE_ID
                    })];
            case 2:
...
var setAudio = function (_a, payload) {
    var commit = _a.commit;
