...
var Kling_vue_1 = require("@/layouts/Kling.vue");
var ConfigPanel_vue_1 = require("@/components/kling/ConfigPanel.vue");
var operators_1 = require("@/operators");
var models_1 = require("@/models");
var element_plus_1 = require("element-plus");
var constants_1 = require("@/constants");
var RecentPanel_vue_1 = require("@/components/kling/RecentPanel.vue");
var CALLBACK_URL = 'https://webhook.acedata.cloud/kling';
exports.default = (0, vue_1.defineComponent)({
    name: 'KlingIndex',
    components: {
        ConfigPanel: ConfigPanel_vue_1.default,
        Layout: Kling_vue_1.default,
    ...
    computed: {
        loading: function () {
            var _a, _b;
            return ((_b = (_a = this.$store.state.kling) === null || _a === void 0 ? void 0 : _a.status) === null || _b === void 0 ? void 0 : _b.getApplications) === models_1.Status.Request;
        },
        credential: function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('kling/getService')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('kling/getApplications')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('kling/getTasks', {
                                    limit: limit,
        ...
        onGenerate: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    element_plus_1.ElMessage.info(this.$t('kling.message.startingTask'));
                    operators_1.klingOperator
                        .generate(request, {
                        token: token
                    })
                        .then(function () {
                        element_plus_1.ElMessage.success(_this.$t('kling.message.startTaskSuccess'));
                    })
                        ...
                        if (((_b = response === null || response === void 0 ? void 0 : response.error) === null || _b === void 0 ? void 0 : _b.code) === constants_1.ERROR_CODE_USED_UP) {
                            element_plus_1.ElMessage.error(_this.$t('kling.message.usedUp'));
                        }
                        else {
                            element_plus_1.ElMessage.error(_this.$t('kling.message.startTaskFailed'));
                        }
                    })
