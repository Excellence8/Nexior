...
var Flux_vue_1 = require("@/layouts/Flux.vue");
var ConfigPanel_vue_1 = require("@/components/flux/ConfigPanel.vue");
var operators_1 = require("@/operators");
var models_1 = require("@/models");
var element_plus_1 = require("element-plus");
var constants_1 = require("@/constants");
var RecentPanel_vue_1 = require("@/components/flux/RecentPanel.vue");
var CALLBACK_URL = 'https://webhook.acedata.cloud/flux';
exports.default = (0, vue_1.defineComponent)({
    name: 'FluxIndex',
    components: {
        ConfigPanel: ConfigPanel_vue_1.default,
        Layout: Flux_vue_1.default,
    ...
    computed: {
        loading: function () {
            var _a, _b;
            return ((_b = (_a = this.$store.state.flux) === null || _a === void 0 ? void 0 : _a.status) === null || _b === void 0 ? void 0 : _b.getApplications) === models_1.Status.Request;
        },
        credential: function () {
            var _a;
            return (_a = this.$store.state.flux) === null || _a === void 0 ? void 0 : _a.credential;
        },
        config: function () {
            var _a;
        ...
        tasks: function () {
            var _a;
            return (_a = this.$store.state.flux) === null || _a === void 0 ? void 0 : _a.tasks;
        }
    },
    watch: {
        tasks: {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('flux/getService')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('flux/getApplications')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('flux/getTasks', {
                                    limit: limit,
        ...
        onGenerate: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    element_plus_1.ElMessage.info(this.$t('flux.message.startingTask'));
                    operators_1.fluxOperator
                        .generate(request, {
                        token: token
                    })
                        .then(function () {
                        element_plus_1.ElMessage.success(_this.$t('flux.message.startTaskSuccess'));
                    })
                        ...
                        if (((_b = response === null || response === void 0 ? void 0 : response.error) === null || _b === void 0 ? void 0 : _b.code) === constants_1.ERROR_CODE_USED_UP) {
                            element_plus_1.ElMessage.error(_this.$t('flux.message.usedUp'));
                        }
                        else {
                            element_plus_1.ElMessage.error(_this.$t('flux.message.startTaskFailed') + ((_c = response === null || response === void 0 ? void 0 : response.error) === null || _c === void 0 ? void 0 : _c.message));
                        }
                    })
