...
var Pika_vue_1 = require("@/layouts/Pika.vue");
var ConfigPanel_vue_1 = require("@/components/pika/ConfigPanel.vue");
var operators_1 = require("@/operators");
var models_1 = require("@/models");
var element_plus_1 = require("element-plus");
var constants_1 = require("@/constants");
var RecentPanel_vue_1 = require("@/components/pika/RecentPanel.vue");
var CALLBACK_URL = 'https://webhook.acedata.cloud/pika';
exports.default = (0, vue_1.defineComponent)({
    name: 'PikaIndex',
    components: {
        ConfigPanel: ConfigPanel_vue_1.default,
        Layout: Pika_vue_1.default,
    ...
    computed: {
        loading: function () {
            var _a, _b;
            return ((_b = (_a = this.$store.state.pika) === null || _a === void 0 ? void 0 : _a.status) === null || _b === void 0 ? void 0 : _b.getApplications) === models_1.Status.Request;
        },
        service: function () {
        ...
        initializing: function () {
            return this.$store.state.pika.status.getApplications === models_1.Status.Request;
        },
        needApply: function () {
            return this.$store.state.pika.status.getApplications === models_1.Status.Success && !this.application;
        },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('pika/getService')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('pika/getApplications')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('pika/getTasks', {
                                    limit: limit,
        ...
        onGenerate: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    element_plus_1.ElMessage.info(this.$t('pika.message.startingTask'));
                    operators_1.pikaOperator
                        .generate(request, {
                        token: token
                    })
                        .then(function () {
                        element_plus_1.ElMessage.success(_this.$t('pika.message.startTaskSuccess'));
                        _this.$store.commit('pika/setConfig', {
                            config: undefined
                        });
                    })
                        .catch(function (error) {
                        ...
                        if (((_b = response === null || response === void 0 ? void 0 : response.error) === null || _b === void 0 ? void 0 : _b.code) === constants_1.ERROR_CODE_USED_UP) {
                            element_plus_1.ElMessage.error(_this.$t('pika.message.usedUp'));
                        }
                        else {
                            element_plus_1.ElMessage.error(_this.$t('pika.message.startTaskFailed'));
                        }
                    })
...
}
{
    ...
    // @ts-ignore
    var __VLS_14 = __VLS_asFunctionalComponent(__VLS_13, new __VLS_13(__assign({ 'onReachTop': {} }, { class: "panel recent" })));
    var __VLS_15 = __VLS_14.apply(void 0, __spreadArray([__assign({ 'onReachTop': {} }, { class: "panel recent" })], __VLS_functionalComponentArgsRest(__VLS_14), false));
    var __VLS_17 = void 0;
    var __VLS_18 = void 0;
    var __VLS_19 = void 0;
    var __VLS_20 = {
