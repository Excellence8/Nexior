...
var Nanobanana_vue_1 = require("@/layouts/Nanobanana.vue");
var ConfigPanel_vue_1 = require("@/components/nanobanana/ConfigPanel.vue");
var operators_1 = require("@/operators");
var models_1 = require("@/models");
var element_plus_1 = require("element-plus");
var constants_1 = require("@/constants");
var RecentPanel_vue_1 = require("@/components/nanobanana/RecentPanel.vue");
var CALLBACK_URL = 'https://webhook.acedata.cloud/nanobanana';
exports.default = (0, vue_1.defineComponent)({
    name: 'NanobananaIndex',
    components: {
        ConfigPanel: ConfigPanel_vue_1.default,
        Layout: Nanobanana_vue_1.default,
    ...
    computed: {
        loading: function () {
            var _a, _b;
            return ((_b = (_a = this.$store.state.nanobanana) === null || _a === void 0 ? void 0 : _a.status) === null || _b === void 0 ? void 0 : _b.getApplications) === models_1.Status.Request;
        },
        credential: function () {
            var _a;
            return (_a = this.$store.state.nanobanana) === null || _a === void 0 ? void 0 : _a.credential;
        },
        config: function () {
            var _a;
        ...
        application: function () {
            var _a;
            return (_a = this.$store.state.nanobanana) === null || _a === void 0 ? void 0 : _a.application;
        },
        tasks: function () {
            var _a;
            return (_a = this.$store.state.nanobanana) === null || _a === void 0 ? void 0 : _a.tasks;
        }
    },
    watch: {
        tasks: {
    ...
    methods: {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('nanobanana/getService')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('nanobanana/getApplications')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('nanobanana/getTasks', {
                                    limit: limit,
        ...
        onGenerate: function () {
            return __awaiter(this, void 0, void 0, function () {
                var cfg, request, token;
                var _this = this;
                var _a;
                return __generator(this, function (_b) {
                    cfg = __assign({}, (this.config || {}));
                    // When action is 'edit', do not send image_urls
                    if ((cfg === null || cfg === void 0 ? void 0 : cfg.action) === 'generate' && 'image_urls' in cfg) {
                        delete cfg.image_urls;
                    }
                    request = __assign(__assign({}, cfg), { callback_url: CALLBACK_URL });
                    token = (_a = this.credential) === null || _a === void 0 ? void 0 : _a.token;
                    if (!token) {
                        console.error('no token specified');
                        return [2 /*return*/];
                    }
                    element_plus_1.ElMessage.info(this.$t('nanobanana.message.startingTask'));
                    operators_1.nanobananaOperator
                        .generate(request, {
                        token: token
                    })
                        .then(function () {
                        element_plus_1.ElMessage.success(_this.$t('nanobanana.message.startTaskSuccess'));
                    })
                        ...
                        if (((_b = response === null || response === void 0 ? void 0 : response.error) === null || _b === void 0 ? void 0 : _b.code) === constants_1.ERROR_CODE_USED_UP) {
                            element_plus_1.ElMessage.error(_this.$t('nanobanana.message.usedUp'));
                        }
                        else {
                            element_plus_1.ElMessage.error(_this.$t('nanobanana.message.startTaskFailed') + (((_c = response === null || response === void 0 ? void 0 : response.error) === null || _c === void 0 ? void 0 : _c.message) || ''));
                        }
                    })
...
}
{
    ...
    var __VLS_13 = {}.RecentPanel;
    /** @type {[typeof __VLS_components.RecentPanel, typeof __VLS_components.recentPanel, ]} */ ;
    // @ts-ignore
    var __VLS_14 = __VLS_asFunctionalComponent(__VLS_13, new __VLS_13(__assign({ 'onReachTop': {} })));
    var __VLS_15 = __VLS_14.apply(void 0, __spreadArray([__assign({ 'onReachTop': {} })], __VLS_functionalComponentArgsRest(__VLS_14), false));
    var __VLS_17 = void 0;
    var __VLS_18 = void 0;
    var __VLS_19 = void 0;
    var __VLS_20 = {
