...
exports.default = (0, vue_1.defineComponent)({
    ...
    methods: {
        ...
        onFetchData: function () {
            var _this = this;
            this.loading = true;
            Promise.all([this.onFetchInvitees()]).finally(function () {
                _this.loading = false;
            });
        },
        onFetchInvitees: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, operators_1.userOperator.getInvitees({
                                limit: this.limit,
...
(__VLS_ctx.$t('common.title.invitee'));
var __VLS_16;
var __VLS_12;
var __VLS_17 = {}.ElRow;
/** @type {[typeof __VLS_components.ElRow, typeof __VLS_components.elRow, typeof __VLS_components.ElRow, typeof __VLS_components.elRow, ]} */ ;
...
var __VLS_34 = __VLS_asFunctionalComponent(__VLS_33, new __VLS_33({
    prop: "id",
    label: (__VLS_ctx.$t('user.field.id')),
...
var __VLS_42 = __VLS_asFunctionalComponent(__VLS_41, new __VLS_41({
    label: (__VLS_ctx.$t('user.field.username')),
    width: "300px",
}));
...
__VLS_44.slots.default;
{
    ...
    ((_a = scope.row) === null || _a === void 0 ? void 0 : _a.username);
}
var __VLS_44;
...
var __VLS_46 = __VLS_asFunctionalComponent(__VLS_45, new __VLS_45({
    label: (__VLS_ctx.$t('user.field.email')),
    width: "300px",
}));
...
__VLS_48.slots.default;
{
    ...
    var scope = __VLS_getSlotParams(__VLS_thisSlot)[0];
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "description" }));
    ((_b = scope.row) === null || _b === void 0 ? void 0 : _b.email);
}
var __VLS_48;
...
var __VLS_50 = __VLS_asFunctionalComponent(__VLS_49, new __VLS_49({
    label: (__VLS_ctx.$t('user.field.nickname')),
    width: "200px",
}));
...
var __VLS_54 = __VLS_asFunctionalComponent(__VLS_53, new __VLS_53({
    label: (__VLS_ctx.$t('user.field.dateJoined')),
}));
...
__VLS_56.slots.default;
{
    ...
    (__VLS_ctx.$dayjs.format(scope.row.date_joined));
}
var __VLS_56;
var __VLS_32;
var __VLS_28;
...
// @ts-ignore
var __VLS_66 = __VLS_asFunctionalComponent(__VLS_65, new __VLS_65(__assign({ 'onChange': {} }, { currentPage: (__VLS_ctx.page), pageSize: (__VLS_ctx.limit), total: (__VLS_ctx.total) })));
var __VLS_67 = __VLS_66.apply(void 0, __spreadArray([__assign({ 'onChange': {} }, { currentPage: (__VLS_ctx.page), pageSize: (__VLS_ctx.limit), total: (__VLS_ctx.total) })], __VLS_functionalComponentArgsRest(__VLS_66), false));
var __VLS_69;
var __VLS_70;
var __VLS_71;
var __VLS_72 = {
