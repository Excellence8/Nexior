...
var Qrart_vue_1 = require("@/layouts/Qrart.vue");
var ConfigPanel_vue_1 = require("@/components/qrart/ConfigPanel.vue");
var operators_1 = require("@/operators");
var models_1 = require("@/models");
var element_plus_1 = require("element-plus");
var constants_1 = require("@/constants");
var Status_vue_1 = require("@/components/application/Status.vue");
var RecentPanel_vue_1 = require("@/components/qrart/RecentPanel.vue");
var CALLBACK_URL = 'https://webhook.acedata.cloud/qrart';
exports.default = (0, vue_1.defineComponent)({
    name: 'QrartIndex',
    components: {
        ConfigPanel: ConfigPanel_vue_1.default,
        Layout: Qrart_vue_1.default,
    ...
    computed: {
        loading: function () {
            var _a, _b;
            return ((_b = (_a = this.$store.state.qrart) === null || _a === void 0 ? void 0 : _a.status) === null || _b === void 0 ? void 0 : _b.getApplications) === models_1.Status.Request;
        },
        service: function () {
        ...
        initializing: function () {
            return this.$store.state.qrart.status.getApplications === models_1.Status.Request;
        },
        needApply: function () {
            return this.$store.state.qrart.status.getApplications === models_1.Status.Success && !this.application;
        },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('qrart/getService')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('qrart/getApplications')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('qrart/getTasks', {
                                    limit: limit,
        ...
        onGenerate: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_v) {
                    request = __assign({ type: (_a = this.config) === null || _a === void 0 ? void 0 : _a.type, content: (_b = this.config) === null || _b === void 0 ? void 0 : _b.content, content_image_url: (_c = this.config) === null || _c === void 0 ? void 0 : _c.content_image_url, prompt: (_d = this.config) === null || _d === void 0 ? void 0 : _d.prompt, aspect_ratio: (_e = this.config) === null || _e === void 0 ? void 0 : _e.aspect_ratio, callback_url: CALLBACK_URL, qrw: (_f = this.config) === null || _f === void 0 ? void 0 : _f.qrw, steps: (_g = this.config) === null || _g === void 0 ? void 0 : _g.steps, preset: (_h = this.config) === null || _h === void 0 ? void 0 : _h.preset }, (((_j = this.config) === null || _j === void 0 ? void 0 : _j.advanced)
                        ? {
                            position: (_k = this.config) === null || _k === void 0 ? void 0 : _k.position,
                            pixel_style: (_l = this.config) === null || _l === void 0 ? void 0 : _l.pixel_style,
                            marker_shape: (_m = this.config) === null || _m === void 0 ? void 0 : _m.marker_shape,
                            sub_marker: (_o = this.config) === null || _o === void 0 ? void 0 : _o.sub_marker,
                            rotate: (_p = this.config) === null || _p === void 0 ? void 0 : _p.rotate,
                            ecl: (_q = this.config) === null || _q === void 0 ? void 0 : _q.ecl,
                            seed: (_r = this.config) === null || _r === void 0 ? void 0 : _r.seed,
                            padding_level: (_s = this.config) === null || _s === void 0 ? void 0 : _s.padding_level,
                            padding_noise: (_t = this.config) === null || _t === void 0 ? void 0 : _t.padding_noise
                        }
                        : {}));
                    token = (_u = this.credential) === null || _u === void 0 ? void 0 : _u.token;
                    if (!token) {
                        console.error('no token specified');
                        return [2 /*return*/];
                    }
                    element_plus_1.ElMessage.info(this.$t('qrart.message.startingTask'));
                    operators_1.qrartOperator
                        .generate(request, {
                        token: token
                    })
                        .then(function () {
                        element_plus_1.ElMessage.success(_this.$t('qrart.message.startTaskSuccess'));
                    })
                        .catch(function (error) {
                        var _a, _b;
                        ...
                        if (((_b = response === null || response === void 0 ? void 0 : response.error) === null || _b === void 0 ? void 0 : _b.code) === constants_1.ERROR_CODE_USED_UP) {
                            element_plus_1.ElMessage.error(_this.$t('qrart.message.usedUp'));
                        }
                        else {
                            element_plus_1.ElMessage.error(_this.$t('qrart.message.startTaskFailed'));
                        }
                    })
...
}
{
    ...
    var __VLS_21 = {
        onSelect: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.$store.dispatch('qrart/setApplication', $event);
        }
    };
    var __VLS_16;
