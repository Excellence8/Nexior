...
var Suno_vue_1 = require("@/layouts/Suno.vue");
var operators_1 = require("@/operators");
var models_1 = require("@/models");
var element_plus_1 = require("element-plus");
var constants_1 = require("@/constants");
var ConfigPanel_vue_1 = require("@/components/suno/ConfigPanel.vue");
var RecentPanel_vue_1 = require("@/components/suno/RecentPanel.vue");
var PreviewPanel_vue_1 = require("@/components/suno/PreviewPanel.vue");
var CALLBACK_URL = 'https://webhook.acedata.cloud/suno';
exports.default = (0, vue_1.defineComponent)({
    name: 'SunoIndex',
    components: {
        Layout: Suno_vue_1.default,
        ConfigPanel: ConfigPanel_vue_1.default,
        RecentPanel: RecentPanel_vue_1.default,
        PreviewPanel: PreviewPanel_vue_1.default
    },
    inject: ['initialized'],
    data: function () {
        return {
    ...
    computed: {
        ...
        initializing: function () {
            return this.$store.state.suno.status.getApplications === models_1.Status.Request;
        },
        needApply: function () {
            return this.$store.state.suno.status.getApplications === models_1.Status.Success && !this.application;
        },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('suno/getService')];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.$store.dispatch('suno/getApplications')];
                        case 1:
                            _a.sent();
...
__VLS_3.slots.default;
{
    ...
    var __VLS_11 = void 0;
    var __VLS_12 = {
        onGenerate: (__VLS_ctx.onGenerateAudio)
    };
    var __VLS_8;
}
{
...
{
    var __VLS_thisSlot = __VLS_3.slots.preview;
    var __VLS_21 = {}.PreviewPanel;
    /** @type {[typeof __VLS_components.PreviewPanel, typeof __VLS_components.previewPanel, ]} */ ;
    // @ts-ignore
