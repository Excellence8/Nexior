...
// @ts-ignore
var __VLS_17 = __VLS_asFunctionalComponent(__VLS_16, new __VLS_16(__assign({ modelValue: (__VLS_ctx.drawer), withHeader: (false), size: "340px" }, { class: "drawer" })));
var __VLS_18 = __VLS_17.apply(void 0, __spreadArray([__assign({ modelValue: (__VLS_ctx.drawer), withHeader: (false), size: "340px" }, { class: "drawer" })], __VLS_functionalComponentArgsRest(__VLS_17), false));
