...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "main flex-1 h-full flex flex-row" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "config w-[300px] h-full flex flex-col border-r border-[var(--el-border-color)]" }));
var __VLS_0 = {};
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "results flex-1 h-full flex flex-col" }));
var __VLS_2 = {};
...
// @ts-ignore
var __VLS_17 = __VLS_asFunctionalComponent(__VLS_16, new __VLS_16(__assign({ modelValue: (__VLS_ctx.drawer), direction: "ltr", withHeader: (false), size: "350px" }, { class: "drawer" })));
var __VLS_18 = __VLS_17.apply(void 0, __spreadArray([__assign({ modelValue: (__VLS_ctx.drawer), direction: "ltr", withHeader: (false), size: "350px" }, { class: "drawer" })], __VLS_functionalComponentArgsRest(__VLS_17), false));
