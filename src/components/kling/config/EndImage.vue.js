...
exports.default = (0, vue_1.defineComponent)({
    ...
    methods: {
        ...
        onSetEndImageUrl: function () {
            var _a, _b;
            var url = (_a = this.urls) === null || _a === void 0 ? void 0 : _a[0];
            this.$store.commit('kling/setConfig', __assign(__assign({}, (_b = this.$store.state.kling) === null || _b === void 0 ? void 0 : _b.config), { end_image_url: url }));
        },
        onSuccess: function () {
