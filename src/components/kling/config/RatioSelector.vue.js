...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b, _c;
                return (_c = (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.kling) === null || _b === void 0 ? void 0 : _b.config) === null || _c === void 0 ? void 0 : _c.aspect_ratio;
            },
            set: function (val) {
                var _a, _b;
                console.debug('set ratio', val);
                this.$store.commit('kling/setConfig', __assign(__assign({}, (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.kling) === null || _b === void 0 ? void 0 : _b.config), { aspect_ratio: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.KLING_DEFAULT_ASPECT_RATIO;
        }
    }
});
