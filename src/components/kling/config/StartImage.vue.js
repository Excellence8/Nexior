...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b, _c;
                return (_c = (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.kling) === null || _b === void 0 ? void 0 : _b.config) === null || _c === void 0 ? void 0 : _c.start_image_url;
            },
            set: function () {
    ...
    methods: {
        onExceed: function () {
            element_plus_1.ElMessage.warning(this.$t('kling.message.uploadReferencesExceed'));
        },
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('kling.message.uploadReferencesError'));
        },
        onSetStartImageUrl: function () {
            var _a, _b, _c;
            var url = (_a = this.urls) === null || _a === void 0 ? void 0 : _a[0];
            this.$store.commit('kling/setConfig', __assign(__assign({}, (_c = (_b = this.$store.state) === null || _b === void 0 ? void 0 : _b.kling) === null || _c === void 0 ? void 0 : _c.config), { start_image_url: url }));
        },
        onSuccess: function () {
...
(__VLS_ctx.$t('kling.button.uploadReferences'));
var __VLS_19;
var __VLS_7;
