...
exports.default = (0, vue_1.defineComponent)({
    ...
    data: function () {
        return {
            options: [
                {
                    value: constants_1.SORA_MODEL_STANDARD,
                    label: 'sora-2'
                },
                {
                    value: constants_1.SORA_MODEL_PRO,
                    label: 'sora-2-pro'
                }
            ]
        };
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.sora) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.model;
            },
            set: function (val) {
                var _a;
                var currentConfig = ((_a = this.$store.state.sora) === null || _a === void 0 ? void 0 : _a.config) || {};
                var allowedDurations = constants_1.SORA_ALLOWED_DURATIONS_BY_MODEL[val] || [constants_1.SORA_DEFAULT_DURATION];
                var currentDuration = currentConfig.duration;
                var resolvedDuration = currentDuration && allowedDurations.includes(currentDuration)
                    ? currentDuration
                    : allowedDurations.includes(constants_1.SORA_DEFAULT_DURATION)
                        ? constants_1.SORA_DEFAULT_DURATION
                        : allowedDurations[0];
                var nextConfig = __assign(__assign({}, currentConfig), { model: val, duration: resolvedDuration, size: currentConfig.size || constants_1.SORA_DEFAULT_SIZE });
    ...
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.SORA_DEFAULT_MODEL;
        }
    }
});
