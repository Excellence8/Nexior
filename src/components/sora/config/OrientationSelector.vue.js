...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.sora) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.orientation;
            },
            set: function (val) {
                var _a, _b;
                console.debug('set orientation', val);
                this.$store.commit('sora/setConfig', __assign(__assign({}, (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.sora) === null || _b === void 0 ? void 0 : _b.config), { orientation: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.SORA_DEFAULT_ORIENTATION;
        }
    }
});
...
(__VLS_ctx.$t('sora.name.orientation'));
...
var _loop_1 = function (option, optionKey) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "preview" }, { class: (option.value) }));
