...
var formatSizeLabel = function (value) {
    if (!value) {
        return value;
    }
...
exports.default = (0, vue_1.defineComponent)({
    ...
    data: function () {
        return {
            options: constants_1.SORA_ALLOWED_SIZES.map(function (size) { return ({
                value: size,
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.sora) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.size;
            },
            set: function (val) {
                var _a;
                var currentConfig = ((_a = this.$store.state.sora) === null || _a === void 0 ? void 0 : _a.config) || {};
                this.$store.commit('sora/setConfig', __assign(__assign({}, currentConfig), { size: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.SORA_DEFAULT_SIZE;
        }
    }
});
