...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b, _c;
                return (_c = (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.sora) === null || _b === void 0 ? void 0 : _b.config) === null || _c === void 0 ? void 0 : _c.image_urls;
            },
            set: function () {
    ...
    methods: {
        onExceed: function () {
            element_plus_1.ElMessage.warning(this.$t('sora.message.uploadReferencesExceed'));
        },
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('sora.message.uploadReferencesError'));
        },
        onSetStartEndImageUrl: function () {
            var _a, _b;
            var urls = this.urls;
            this.$store.commit('sora/setConfig', __assign(__assign({}, (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.sora) === null || _b === void 0 ? void 0 : _b.config), { image_urls: urls }));
        },
        onSuccess: function () {
...
// @ts-ignore
var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign(__assign({ fileList: (__VLS_ctx.fileList), name: "file", accept: ".png,.jpg,.jpeg,.gif,.bmp,.webp", limit: (2) }, { class: "upload-wrapper" }), { multiple: (false), action: (__VLS_ctx.uploadUrl), listType: "picture", onExceed: (__VLS_ctx.onExceed), onError: (__VLS_ctx.onError), onSuccess: (__VLS_ctx.onSuccess), headers: (__VLS_ctx.headers) })));
var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign(__assign({ fileList: (__VLS_ctx.fileList), name: "file", accept: ".png,.jpg,.jpeg,.gif,.bmp,.webp", limit: (2) }, { class: "upload-wrapper" }), { multiple: (false), action: (__VLS_ctx.uploadUrl), listType: "picture", onExceed: (__VLS_ctx.onExceed), onError: (__VLS_ctx.onError), onSuccess: (__VLS_ctx.onSuccess), headers: (__VLS_ctx.headers) })], __VLS_functionalComponentArgsRest(__VLS_5), false));
...
(__VLS_ctx.$t('sora.button.uploadReferences'));
var __VLS_19;
var __VLS_7;
