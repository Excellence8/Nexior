...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            ...
            set: function (val) {
                this.$store.commit('midjourney/setConfig', __assign(__assign({}, this.$store.state.midjourney.config), { elements: val }));
            }
        }
    },
    methods: {
        onToggle: function (item) {
            if (this.value.includes(item)) {
                this.value = this.value.filter(function (v) { return v !== item; });
            }
            else {
                this.value.push(item);
                this.$store.commit('midjourney/setConfig', __assign(__assign({}, this.$store.state.midjourney.config), { elements: this.value }));
            }
        }
    }
});
...
// @ts-ignore
var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign({ 'onClick': {} }, { round: true, type: "primary", size: "small" })));
var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { round: true, type: "primary", size: "small" })], __VLS_functionalComponentArgsRest(__VLS_5), false));
var __VLS_8;
var __VLS_9;
var __VLS_10;
var __VLS_11 = {
    onClick: function () {
        ...
        var $event = _a[0];
        __VLS_ctx.choosing = true;
    }
};
__VLS_7.slots.default;
(__VLS_ctx.$t('midjourney.button.select'));
var __VLS_7;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
var _loop_1 = function (tag, index) {
    ...
    // @ts-ignore
    var __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12(__assign(__assign({ 'onClose': {} }, { key: (index), closable: true, effect: "dark", round: true }), { class: "mr-1 mb-1" })));
    var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign(__assign({ 'onClose': {} }, { key: (index), closable: true, effect: "dark", round: true }), { class: "mr-1 mb-1" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
    var __VLS_16 = void 0;
    var __VLS_17 = void 0;
    var __VLS_18 = void 0;
    var __VLS_19 = {
...
for (var _c = 0, _d = __VLS_getVForSourceType((__VLS_ctx.elements)); _c < _d.length; _c++) {
    var _e = _d[_c], element = _e[0], elementKey = _e[1];
    var __VLS_28 = {}.ElTabPane;
    /** @type {[typeof __VLS_components.ElTabPane, typeof __VLS_components.elTabPane, typeof __VLS_components.ElTabPane, typeof __VLS_components.elTabPane, ]} */ ;
    // @ts-ignore
    var __VLS_29 = __VLS_asFunctionalComponent(__VLS_28, new __VLS_28(__assign({ key: (elementKey), label: (element.displayName), name: (elementKey) }, { class: "pane" })));
    var __VLS_30 = __VLS_29.apply(void 0, __spreadArray([__assign({ key: (elementKey), label: (element.displayName), name: (elementKey) }, { class: "pane" })], __VLS_functionalComponentArgsRest(__VLS_29), false));
    __VLS_31.slots.default;
    var _loop_2 = function (item, itemKey) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign(__assign({ onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.onToggle(item);
            } }, { key: (itemKey) }), { class: ({
                hidden: item === null || item === void 0 ? void 0 : item.advanced,
                item: true,
                active: __VLS_ctx.value.includes(item)
            }) }));
        var __VLS_32 = {}.ElIcon;
        ...
        var __VLS_40 = {}.ElImage;
        /** @type {[typeof __VLS_components.ElImage, typeof __VLS_components.elImage, ]} */ ;
        // @ts-ignore
        var __VLS_41 = __VLS_asFunctionalComponent(__VLS_40, new __VLS_40(__assign({ src: (item.image), fit: "fill" }, { class: "preview" })));
        var __VLS_42 = __VLS_41.apply(void 0, __spreadArray([__assign({ src: (item.image), fit: "fill" }, { class: "preview" })], __VLS_functionalComponentArgsRest(__VLS_41), false));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "name" }));
        (item.label);
    };
    var __VLS_35;
    for (var _f = 0, _g = __VLS_getVForSourceType((element.items)); _f < _g.length; _f++) {
        var _h = _g[_f], item = _h[0], itemKey = _h[1];
        _loop_2(item, itemKey);
    }
    var __VLS_31;
}
var __VLS_27;
