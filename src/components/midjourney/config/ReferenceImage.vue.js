    ...
    watch: {
        urls: {
            handler: function (val) {
                ...
                this.$store.commit('midjourney/setConfig', __assign(__assign({}, this.$store.state.midjourney.config), { references: val }));
            }
        }
    },
    methods: {
        onExceed: function () {
            element_plus_1.ElMessage.warning(this.$t('midjourney.message.uploadReferencesExceed'));
        },
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('midjourney.message.uploadReferencesError'));
        }
    }
});
...
(__VLS_ctx.$t('midjourney.name.referenceImage'));
var __VLS_0 = {}.InfoIcon;
/** @type {[typeof __VLS_components.InfoIcon, typeof __VLS_components.infoIcon, ]} */ ;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({
    content: (__VLS_ctx.$t('midjourney.description.uploadReferences')),
}));
...
(__VLS_ctx.$t('midjourney.button.uploadReferences'));
var __VLS_19;
var __VLS_7;
