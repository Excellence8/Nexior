    ...
    computed: {
        value: {
            ...
            set: function (val) {
                ...
                this.$store.commit('midjourney/setConfig', __assign(__assign({}, this.$store.state.midjourney.config), { stylize: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.MIDJOURNEY_DEFAULT_STYLIZE;
        }
    }
});
