...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            ...
            set: function (val) {
                this.$store.commit('midjourney/setConfig', __assign(__assign({}, this.$store.state.midjourney.config), { quality: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.MIDJOURNEY_DEFAULT_QUALITY;
        }
    }
});
...
(__VLS_ctx.$t('midjourney.name.quality'));
