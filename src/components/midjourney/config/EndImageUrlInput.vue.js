    ...
    watch: {
        urls: {
            handler: function (val) {
                ...
                this.$store.commit('midjourney/setConfig', __assign(__assign({}, this.$store.state.midjourney.config), { end_image_url: val[0] }));
            }
        }
    },
    methods: {
        ...
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('midjourney.message.uploadEndImageError'));
        }
    }
});
