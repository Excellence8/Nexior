...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.midjourney) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.resolution;
            },
            set: function (val) {
                this.$store.commit('midjourney/setConfig', __assign(__assign({}, this.$store.state.midjourney.config), { resolution: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.MIDJOURNEY_DEFAULT_RESOLUTION;
        }
    }
});
...
(__VLS_ctx.$t('midjourney.name.resolution'));
