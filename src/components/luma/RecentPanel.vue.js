...
var BotPlaceholder_vue_1 = require("../common/BotPlaceholder.vue");
...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        tasks: function () {
            ...
            return __assign(__assign({}, (_a = this.$store.state.luma) === null || _a === void 0 ? void 0 : _a.tasks), { items: (_d = (_c = (_b = this.$store.state.luma) === null || _b === void 0 ? void 0 : _b.tasks) === null || _c === void 0 ? void 0 : _c.items) === null || _d === void 0 ? void 0 : _d.slice() });
        }
    },
    methods: {
...
if (((_a = __VLS_ctx.tasks) === null || _a === void 0 ? void 0 : _a.items) === undefined) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "tasks w-full h-full overflow-y-auto" }));
    for (var _i = 0, _j = __VLS_getVForSourceType(((_f = __VLS_ctx.tasks) === null || _f === void 0 ? void 0 : _f.items)); _i < _j.length; _i++) {
        ...
        // @ts-ignore
        var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign({ 'onExtend': {} }, { key: (task.id), modelValue: (task) })));
        var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign({ 'onExtend': {} }, { key: (task.id), modelValue: (task) })], __VLS_functionalComponentArgsRest(__VLS_5), false));
        var __VLS_8 = void 0;
        var __VLS_9 = void 0;
        var __VLS_10 = void 0;
        var __VLS_11 = {
            onExtend: function () {
                ...
                if (!!(((_a = __VLS_ctx.tasks) === null || _a === void 0 ? void 0 : _a.items) === undefined))
                    return;
                if (!(((_c = (_b = __VLS_ctx.tasks) === null || _b === void 0 ? void 0 : _b.items) === null || _c === void 0 ? void 0 : _c.length) && ((_e = (_d = __VLS_ctx.tasks) === null || _d === void 0 ? void 0 : _d.items) === null || _e === void 0 ? void 0 : _e.length) > 0))
                    return;
