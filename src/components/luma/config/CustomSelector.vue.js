...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.luma) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.custom;
            },
            set: function (val) {
                var _a;
                console.debug('set custom', val);
                this.$store.commit('luma/setConfig', __assign(__assign({}, (_a = this.$store.state.luma) === null || _a === void 0 ? void 0 : _a.config), { custom: val }));
            }
        }
    },
    mounted: function () {
        if (this.value === undefined) {
            this.value = constants_1.LUMA_DEFAULT_CUSTOM;
        }
    }
});
