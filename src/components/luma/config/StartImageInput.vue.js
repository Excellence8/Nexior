...
exports.default = (0, vue_1.defineComponent)({
    ...
    methods: {
        ...
        onSetStartImageUrl: function () {
            ...
            this.$store.commit('luma/setConfig', __assign(__assign({}, (_b = this.$store.state.luma) === null || _b === void 0 ? void 0 : _b.config), { start_image_url: url }));
        },
        onSuccess: function () {
...
__VLS_7.slots.default;
{
    ...
    if (file_1.percentage != undefined) {
        ...
        // @ts-ignore
        var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign({ 'onRemove': {} }, { url: (file_1.url || file_1.response.file_url), name: (file_1.name), percentage: (file_1.percentage) })));
        var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign({ 'onRemove': {} }, { url: (file_1.url || file_1.response.file_url), name: (file_1.name), percentage: (file_1.percentage) })], __VLS_functionalComponentArgsRest(__VLS_9), false));
        var __VLS_12 = void 0;
        var __VLS_13 = void 0;
        var __VLS_14 = void 0;
        var __VLS_15 = {
...
(__VLS_ctx.$t('luma.button.uploadStartImageUrl'));
var __VLS_19;
var __VLS_7;
