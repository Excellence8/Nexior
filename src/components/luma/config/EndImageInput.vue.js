...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b, _c;
                return (_c = (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.luma) === null || _b === void 0 ? void 0 : _b.config) === null || _c === void 0 ? void 0 : _c.start_image_url;
            },
            set: function () { }
        }
    },
    ...
    methods: {
        onExceed: function () {
            element_plus_1.ElMessage.warning(this.$t('luma.message.uploadReferencesExceed'));
        },
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('luma.message.uploadReferencesError'));
        },
        onSetEndImageUrl: function () {
            var _a, _b;
            var url = (_a = this.urls) === null || _a === void 0 ? void 0 : _a[0];
            this.$store.commit('luma/setConfig', __assign(__assign({}, (_b = this.$store.state.luma) === null || _b === void 0 ? void 0 : _b.config), { end_image_url: url }));
        },
        onSuccess: function () {
...
(__VLS_ctx.$t('luma.button.uploadEndImageUrl'));
var __VLS_19;
var __VLS_7;
