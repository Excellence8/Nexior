...
var EnhancementSelector_vue_1 = require("./config/EnhancementSelector.vue");
var CustomSelector_vue_1 = require("./config/CustomSelector.vue");
var LoopSelector_vue_1 = require("./config/LoopSelector.vue");
var EndImageInput_vue_1 = require("./config/EndImageInput.vue");
var StartImageInput_vue_1 = require("./config/StartImageInput.vue");
// @ts-ignore
var UploadVideo_vue_1 = require("./config/UploadVideo.vue");
...
exports.default = (0, vue_1.defineComponent)({
    ...
    components: {
        ...
        StartImageInput: StartImageInput_vue_1.default,
        EndImageInput: EndImageInput_vue_1.default,
        EnhancementSelector: EnhancementSelector_vue_1.default,
        ...
        CustomSelector: CustomSelector_vue_1.default,
        UploadVideo: UploadVideo_vue_1.default,
    ...
    computed: {
        ...
        service: function () {
            var _a;
            return (_a = this.$store.state.luma) === null || _a === void 0 ? void 0 : _a.service;
        }
    },
    methods: {
        onGenerate: function () {
...
if (((_a = __VLS_ctx.config) === null || _a === void 0 ? void 0 : _a.video_id) || ((_b = __VLS_ctx.config) === null || _b === void 0 ? void 0 : _b.video_url)) {
    var __VLS_0 = {}.ExtendFromInput;
...
if (!((_c = __VLS_ctx.config) === null || _c === void 0 ? void 0 : _c.video_id)) {
    var __VLS_8 = {}.CustomSelector;
    /** @type {[typeof __VLS_components.CustomSelector, typeof __VLS_components.customSelector, ]} */ ;
    // @ts-ignore
...
if ((_d = __VLS_ctx.config) === null || _d === void 0 ? void 0 : _d.custom) {
    var __VLS_12 = {}.UploadVideo;
    /** @type {[typeof __VLS_components.UploadVideo, typeof __VLS_components.uploadVideo, ]} */ ;
    // @ts-ignore
...
if (!(((_e = __VLS_ctx.config) === null || _e === void 0 ? void 0 : _e.video_id) || ((_f = __VLS_ctx.config) === null || _f === void 0 ? void 0 : _f.video_url)) && !((_g = __VLS_ctx.config) === null || _g === void 0 ? void 0 : _g.custom)) {
    var __VLS_16 = {}.StartImageInput;
    /** @type {[typeof __VLS_components.StartImageInput, typeof __VLS_components.startImageInput, ]} */ ;
    // @ts-ignore
...
var __VLS_20 = {}.EndImageInput;
/** @type {[typeof __VLS_components.EndImageInput, typeof __VLS_components.endImageInput, ]} */ ;
// @ts-ignore
...
var __VLS_24 = {}.EnhancementSelector;
/** @type {[typeof __VLS_components.EnhancementSelector, typeof __VLS_components.enhancementSelector, ]} */ ;
// @ts-ignore
...
if (((_h = __VLS_ctx.config) === null || _h === void 0 ? void 0 : _h.video_url) !== undefined || ((_j = __VLS_ctx.config) === null || _j === void 0 ? void 0 : _j.custom)) {
    ...
    (__VLS_ctx.$t('luma.button.generate'));
    var __VLS_51;
}
