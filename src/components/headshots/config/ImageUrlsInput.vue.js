...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        urls: function () {
            ...
            return this.fileList.map(function (file) {
                var _a;
                return (_a = file === null || file === void 0 ? void 0 : file.response) === null || _a === void 0 ? void 0 : _a.file_url;
            });
        },
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.headshots) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.image_urls;
            },
            set: function () {
                var _a;
                var url = this.urls;
                this.$store.commit('headshots/setConfig', __assign(__assign({}, (_a = this.$store.state.headshots) === null || _a === void 0 ? void 0 : _a.config), { image_urls: url }));
            }
        }
    },
    mounted: function () {
    ...
    methods: {
        onExceed: function () {
            element_plus_1.ElMessage.warning(this.$t('headshots.message.uploadImageExceed'));
        },
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('headshots.message.uploadImageError'));
        },
        onSetImageUrls: function () {
            var _a;
            var urls = this.urls;
            this.$store.commit('headshots/setConfig', __assign(__assign({}, (_a = this.$store.state.headshots) === null || _a === void 0 ? void 0 : _a.config), { image_urls: urls }));
        },
        onSuccess: function () {
...
(__VLS_ctx.$t('headshots.name.endImageUrls'));
...
(__VLS_ctx.$t('headshots.button.uploadImageUrls'));
var __VLS_15;
var __VLS_3;
var __VLS_20 = {}.InfoIcon;
/** @type {[typeof __VLS_components.InfoIcon, typeof __VLS_components.infoIcon, ]} */ ;
// @ts-ignore
var __VLS_21 = __VLS_asFunctionalComponent(__VLS_20, new __VLS_20(__assign({ content: (__VLS_ctx.$t('headshots.description.endImageUrls')) }, { class: "info" })));
var __VLS_22 = __VLS_21.apply(void 0, __spreadArray([__assign({ content: (__VLS_ctx.$t('headshots.description.endImageUrls')) }, { class: "info" })], __VLS_functionalComponentArgsRest(__VLS_21), false));
