...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.veo) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.translation;
            },
            set: function (val) {
                var _a;
                console.debug('set translation', val);
                this.$store.commit('veo/setConfig', __assign(__assign({}, (_a = this.$store.state.veo) === null || _a === void 0 ? void 0 : _a.config), { translation: val }));
            }
        }
    },
    mounted: function () {
        if (this.value === undefined) {
            this.value = constants_1.VEO_DEFAULT_TRANSLATION;
        }
    }
});
