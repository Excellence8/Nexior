...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b, _c;
                return (_c = (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.veo) === null || _b === void 0 ? void 0 : _b.config) === null || _c === void 0 ? void 0 : _c.image_urls;
            },
            set: function () {
    ...
    methods: {
        onExceed: function () {
            element_plus_1.ElMessage.warning(this.$t('veo.message.uploadReferencesExceed'));
        },
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('veo.message.uploadReferencesError'));
        },
        onSetStartEndImageUrl: function () {
            var _a, _b;
            var urls = this.urls;
            this.$store.commit('veo/setConfig', __assign(__assign({}, (_b = (_a = this.$store.state) === null || _a === void 0 ? void 0 : _a.veo) === null || _b === void 0 ? void 0 : _b.config), { image_urls: urls }));
        },
        onSuccess: function () {
...
(__VLS_ctx.$t('veo.button.uploadReferences'));
var __VLS_19;
var __VLS_7;
