...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        active: function () {
            var _this = this;
            return this.options.findIndex(function (option) { return option.value === String(_this.value); }) || 0;
        },
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.qrart) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.aspect_ratio;
            },
            set: function (val) {
                var _a;
                console.debug('set aspect ratio', val);
                this.$store.commit('qrart/setConfig', __assign(__assign({}, (_a = this.$store.state.qrart) === null || _a === void 0 ? void 0 : _a.config), { aspect_ratio: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.QRART_DEFAULT_ASPECT_RATIO;
        }
    }
});
...
(__VLS_ctx.$t('qrart.name.aspectRatio'));
