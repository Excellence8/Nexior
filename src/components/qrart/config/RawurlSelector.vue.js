...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.qrart) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.rawurl;
            },
            set: function (val) {
                var _a;
                console.debug('set rawurl', val);
                this.$store.commit('qrart/setConfig', __assign(__assign({}, (_a = this.$store.state.qrart) === null || _a === void 0 ? void 0 : _a.config), { rawurl: val }));
            }
        }
    },
    mounted: function () {
        if (this.value === undefined) {
            this.value = constants_1.QRART_DEFAULT_RAWURL;
        }
    }
});
