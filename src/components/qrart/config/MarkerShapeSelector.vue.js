...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.qrart) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.marker_shape;
            },
            set: function (val) {
                var _a;
                console.debug('set marker_shape', val);
                this.$store.commit('qrart/setConfig', __assign(__assign({}, (_a = this.$store.state.qrart) === null || _a === void 0 ? void 0 : _a.config), { marker_shape: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.QRART_DEFAULT_MARKER_SHAPE;
        }
    }
});
...
(__VLS_ctx.$t('qrart.name.markerShape'));
var __VLS_0 = {}.ElSelect;
/** @type {[typeof __VLS_components.ElSelect, typeof __VLS_components.elSelect, typeof __VLS_components.ElSelect, typeof __VLS_components.elSelect, ]} */ ;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign(__assign({ modelValue: (__VLS_ctx.value), clearable: true }, { class: "value" }), { placeholder: (__VLS_ctx.$t('qrart.placeholder.markerShape')) })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({ modelValue: (__VLS_ctx.value), clearable: true }, { class: "value" }), { placeholder: (__VLS_ctx.$t('qrart.placeholder.markerShape')) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
