...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.flux) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.count;
            },
            set: function (val) {
                var _a;
                console.debug('set count', val);
                this.$store.commit('flux/setConfig', __assign(__assign({}, (_a = this.$store.state.flux) === null || _a === void 0 ? void 0 : _a.config), { count: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.FLUX_DEFAULT_COUNT;
        }
    }
});
