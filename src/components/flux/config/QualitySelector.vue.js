...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        value: {
            get: function () {
                var _a;
                return (_a = this.$store.state.flux.config) === null || _a === void 0 ? void 0 : _a.quality;
            },
            set: function (val) {
                console.debug('set quality', val);
                this.$store.commit('flux/setConfig', __assign(__assign({}, this.$store.state.flux.config), { quality: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.FLUX_DEFAULT_QUALITY;
        }
    }
});
