...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.flux) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.aspect_ratio;
            },
            set: function (val) {
                console.debug('set ratio', val);
                this.$store.commit('flux/setConfig', __assign(__assign({}, this.$store.state.flux.config), { aspect_ratio: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.FLUX_DEFAULT_ASPECT_RATIO;
        }
    }
});
