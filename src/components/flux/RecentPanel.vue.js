...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        tasks: function () {
            ...
            return __assign(__assign({}, (_a = this.$store.state.flux) === null || _a === void 0 ? void 0 : _a.tasks), { items: (_d = (_c = (_b = this.$store.state.flux) === null || _b === void 0 ? void 0 : _b.tasks) === null || _c === void 0 ? void 0 : _c.items) === null || _d === void 0 ? void 0 : _d.slice() });
        }
    },
    methods: {
