...
// @ts-ignore
var __VLS_10 = __VLS_asFunctionalComponent(__VLS_9, new __VLS_9(__assign({ 'onConfirm': {} }, { modelValue: (__VLS_ctx.site.description), title: (__VLS_ctx.$t('site.title.editDescription')), placeholder: (__VLS_ctx.$t('site.placeholder.description')) })));
var __VLS_11 = __VLS_10.apply(void 0, __spreadArray([__assign({ 'onConfirm': {} }, { modelValue: (__VLS_ctx.site.description), title: (__VLS_ctx.$t('site.title.editDescription')), placeholder: (__VLS_ctx.$t('site.placeholder.description')) })], __VLS_functionalComponentArgsRest(__VLS_10), false));
var __VLS_13;
var __VLS_14;
var __VLS_15;
var __VLS_16 = {
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "block w-full" }));
((_a = __VLS_ctx.site.keywords) === null || _a === void 0 ? void 0 : _a.join(', '));
var __VLS_21 = {}.EditArray;
/** @type {[typeof __VLS_components.EditArray, typeof __VLS_components.editArray, ]} */ ;
// @ts-ignore
var __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21(__assign({ 'onConfirm': {} }, { modelValue: (((_b = __VLS_ctx.site) === null || _b === void 0 ? void 0 : _b.keywords) || []), title: (__VLS_ctx.$t('site.title.editKeywords')), placeholder: (__VLS_ctx.$t('site.placeholder.keywords')), tip: (__VLS_ctx.$t('site.message.keywordsTip2')) })));
var __VLS_23 = __VLS_22.apply(void 0, __spreadArray([__assign({ 'onConfirm': {} }, { modelValue: (((_c = __VLS_ctx.site) === null || _c === void 0 ? void 0 : _c.keywords) || []), title: (__VLS_ctx.$t('site.title.editKeywords')), placeholder: (__VLS_ctx.$t('site.placeholder.keywords')), tip: (__VLS_ctx.$t('site.message.keywordsTip2')) })], __VLS_functionalComponentArgsRest(__VLS_22), false));
var __VLS_25;
var __VLS_26;
var __VLS_27;
var __VLS_28 = {
