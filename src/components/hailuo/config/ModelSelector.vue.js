...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.hailuo) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.model;
            },
            set: function (val) {
                var _a;
                this.$store.commit('hailuo/setConfig', __assign(__assign({}, (_a = this.$store.state.hailuo) === null || _a === void 0 ? void 0 : _a.config), { model: val }));
            }
        }
    },
    mounted: function () {
        if (!this.value) {
            this.value = constants_1.HAILUO_DEFAULT_MODEL;
        }
    }
});
...
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign(__assign({ modelValue: (__VLS_ctx.value) }, { class: "value" }), { placeholder: (__VLS_ctx.$t('hailuo.placeholder.select')), clearable: true })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({ modelValue: (__VLS_ctx.value) }, { class: "value" }), { placeholder: (__VLS_ctx.$t('hailuo.placeholder.select')), clearable: true })], __VLS_functionalComponentArgsRest(__VLS_1), false));
