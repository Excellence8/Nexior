...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        ...
        urls: function () {
            return this.fileList.map(function (file) { return file.url; }).filter(function (url) { return url !== undefined; });
        },
        value: {
            get: function () {
                var _a, _b;
                return (_b = (_a = this.$store.state.hailuo) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.first_image_url;
            },
            set: function () {
                var _a, _b;
                var url = (_a = this.urls) === null || _a === void 0 ? void 0 : _a[0];
                this.$store.commit('hailuo/setConfig', __assign(__assign({}, (_b = this.$store.state.hailuo) === null || _b === void 0 ? void 0 : _b.config), { first_image_url: url }));
            }
        }
    },
    mounted: function () {
    ...
    methods: {
        onExceed: function () {
            element_plus_1.ElMessage.warning(this.$t('hailuo.message.uploadStartImageExceed'));
        },
        onError: function () {
            element_plus_1.ElMessage.error(this.$t('hailuo.message.uploadStartImageError'));
        },
        onRemove: function () {
...
(__VLS_ctx.$t('hailuo.name.startImageUrl'));
var __VLS_0 = {}.InfoIcon;
/** @type {[typeof __VLS_components.InfoIcon, typeof __VLS_components.infoIcon, ]} */ ;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign({ content: (__VLS_ctx.$t('hailuo.description.startImageUrl')) }, { class: "info" })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ content: (__VLS_ctx.$t('hailuo.description.startImageUrl')) }, { class: "info" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
...
__VLS_7.slots.default;
{
    ...
    if (file_1.url && file_1.percentage !== undefined) {
        var __VLS_8 = {}.ImagePreview;
        /** @type {[typeof __VLS_components.ImagePreview, typeof __VLS_components.imagePreview, ]} */ ;
        // @ts-ignore
        var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign({ 'onRemove': {} }, { url: (file_1.url), name: (file_1.name), percentage: (file_1.percentage) })));
        var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign({ 'onRemove': {} }, { url: (file_1.url), name: (file_1.name), percentage: (file_1.percentage) })], __VLS_functionalComponentArgsRest(__VLS_9), false));
        var __VLS_12 = void 0;
        var __VLS_13 = void 0;
        var __VLS_14 = void 0;
        var __VLS_15 = {
...
// @ts-ignore
var __VLS_17 = __VLS_asFunctionalComponent(__VLS_16, new __VLS_16(__assign(__assign({ size: "small", type: "primary" }, { class: "btn btn-upload" }), { round: true })));
var __VLS_18 = __VLS_17.apply(void 0, __spreadArray([__assign(__assign({ size: "small", type: "primary" }, { class: "btn btn-upload" }), { round: true })], __VLS_functionalComponentArgsRest(__VLS_17), false));
__VLS_19.slots.default;
(__VLS_ctx.$t('hailuo.button.uploadStartImageUrl'));
var __VLS_19;
var __VLS_7;
