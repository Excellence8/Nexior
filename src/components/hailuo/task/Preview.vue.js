...
exports.default = (0, vue_1.defineComponent)({
    ...
    computed: {
        application: function () {
            var _a;
            return (_a = this.$store.state.hailuo) === null || _a === void 0 ? void 0 : _a.application;
        },
        config: function () {
            var _a;
        ...
        video: function () {
            var _a, _b, _c;
            return (_c = (_b = (_a = this.modelValue) === null || _a === void 0 ? void 0 : _a.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c[0];
        }
    },
    methods: {
        onDownload: function (videoUrl) {
...
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign({ src: "https://cdn.acedata.cloud/0qg4gp.png" }, { class: "avatar" })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ src: "https://cdn.acedata.cloud/0qg4gp.png" }, { class: "avatar" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
...
(__VLS_ctx.$t('hailuo.name.hailuoBot'));
...
if ((_c = (_b = __VLS_ctx.modelValue) === null || _b === void 0 ? void 0 : _b.request) === null || _c === void 0 ? void 0 : _c.prompt) {
    ...
    if (!((_f = __VLS_ctx.modelValue) === null || _f === void 0 ? void 0 : _f.response)) {
        ...
        (__VLS_ctx.$t('hailuo.status.pending'));
    }
    if (((_g = __VLS_ctx.video) === null || _g === void 0 ? void 0 : _g.state) === 'processing' || ((_h = __VLS_ctx.video) === null || _h === void 0 ? void 0 : _h.state) === 'pending' || ((_j = __VLS_ctx.video) === null || _j === void 0 ? void 0 : _j.state) === 'running') {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        (__VLS_ctx.$t('hailuo.status.processing'));
    }
}
if (((_l = (_k = __VLS_ctx.modelValue) === null || _k === void 0 ? void 0 : _k.response) === null || _l === void 0 ? void 0 : _l.success) === true) {
    ...
    if ((_m = __VLS_ctx.video) === null || _m === void 0 ? void 0 : _m.video_url) {
        ...
        var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4({
            src: ((_o = __VLS_ctx.video) === null || _o === void 0 ? void 0 : _o.video_url),
        }));
        var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([{
                src: ((_p = __VLS_ctx.video) === null || _p === void 0 ? void 0 : _p.video_url),
    ...
    if (__VLS_ctx.video) {
        ...
        // @ts-ignore
        var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign({ class: "box-item" }, { effect: "dark", content: (__VLS_ctx.$t('hailuo.message.downloadVideo')), placement: "top-start" })));
        var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign({ class: "box-item" }, { effect: "dark", content: (__VLS_ctx.$t('hailuo.message.downloadVideo')), placement: "top-start" })], __VLS_functionalComponentArgsRest(__VLS_9), false));
        __VLS_11.slots.default;
        if ((_q = __VLS_ctx.video) === null || _q === void 0 ? void 0 : _q.video_url) {
            var __VLS_12 = {}.ElButton;
            /** @type {[typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ]} */ ;
            // @ts-ignore
            var __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12(__assign(__assign({ 'onClick': {} }, { type: "info", size: "small" }), { class: "mb-2" })));
            var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign(__assign({ 'onClick': {} }, { type: "info", size: "small" }), { class: "mb-2" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
            var __VLS_16 = void 0;
            var __VLS_17 = void 0;
            var __VLS_18 = void 0;
            var __VLS_19 = {
                onClick: function () {
                    ...
                    if (!(__VLS_ctx.video))
                        return;
                    if (!((_c = __VLS_ctx.video) === null || _c === void 0 ? void 0 : _c.video_url))
                        return;
                    __VLS_ctx.onDownload((_d = __VLS_ctx.video) === null || _d === void 0 ? void 0 : _d.video_url);
                }
            };
            __VLS_15.slots.default;
            (__VLS_ctx.$t('hailuo.button.download'));
            var __VLS_15;
        }
        var __VLS_11;
    }
    ...
    if ((_s = (_r = __VLS_ctx.modelValue) === null || _r === void 0 ? void 0 : _r.request) === null || _s === void 0 ? void 0 : _s.model) {
        ...
        (__VLS_ctx.$t('hailuo.name.model'));
        ((_u = (_t = __VLS_ctx.modelValue) === null || _t === void 0 ? void 0 : _t.request) === null || _u === void 0 ? void 0 : _u.model);
        ...
        var __VLS_29 = __VLS_asFunctionalComponent(__VLS_28, new __VLS_28({
            content: ((_v = __VLS_ctx.modelValue) === null || _v === void 0 ? void 0 : _v.id),
        }));
        var __VLS_30 = __VLS_29.apply(void 0, __spreadArray([{
                content: ((_w = __VLS_ctx.modelValue) === null || _w === void 0 ? void 0 : _w.id),
    ...
    (__VLS_ctx.$t('hailuo.name.taskId'));
...
if (((_1 = (_0 = __VLS_ctx.modelValue) === null || _0 === void 0 ? void 0 : _0.response) === null || _1 === void 0 ? void 0 : _1.success) === false) {
    ...
    var __VLS_40 = {}.ElAlert;
    /** @type {[typeof __VLS_components.ElAlert, typeof __VLS_components.elAlert, typeof __VLS_components.ElAlert, typeof __VLS_components.elAlert, ]} */ ;
    // @ts-ignore
    var __VLS_41 = __VLS_asFunctionalComponent(__VLS_40, new __VLS_40(__assign({ closable: (false) }, { class: "failure" })));
    var __VLS_42 = __VLS_41.apply(void 0, __spreadArray([__assign({ closable: (false) }, { class: "failure" })], __VLS_functionalComponentArgsRest(__VLS_41), false));
    __VLS_43.slots.default;
    {
        var __VLS_thisSlot = __VLS_43.slots.template;
        var __VLS_44 = {}.FontAwesomeIcon;
        /** @type {[typeof __VLS_components.FontAwesomeIcon, typeof __VLS_components.fontAwesomeIcon, ]} */ ;
        // @ts-ignore
        var __VLS_45 = __VLS_asFunctionalComponent(__VLS_44, new __VLS_44(__assign({ icon: "fa-solid fa-exclamation-triangle" }, { class: "mr-1" })));
        var __VLS_46 = __VLS_45.apply(void 0, __spreadArray([__assign({ icon: "fa-solid fa-exclamation-triangle" }, { class: "mr-1" })], __VLS_functionalComponentArgsRest(__VLS_45), false));
        (__VLS_ctx.$t('hailuo.name.failure'));
    }
    __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)(__assign({ class: "text-[var(--el-text-color-regular)] text-xs mb-2" }));
    var __VLS_48 = {}.FontAwesomeIcon;
    /** @type {[typeof __VLS_components.FontAwesomeIcon, typeof __VLS_components.fontAwesomeIcon, ]} */ ;
    // @ts-ignore
    var __VLS_49 = __VLS_asFunctionalComponent(__VLS_48, new __VLS_48(__assign({ icon: "fa-solid fa-magic" }, { class: "mr-1" })));
    var __VLS_50 = __VLS_49.apply(void 0, __spreadArray([__assign({ icon: "fa-solid fa-magic" }, { class: "mr-1" })], __VLS_functionalComponentArgsRest(__VLS_49), false));
    (__VLS_ctx.$t('hailuo.name.taskId'));
    ...
    /** @type {[typeof __VLS_components.FontAwesomeIcon, typeof __VLS_components.fontAwesomeIcon, ]} */ ;
    // @ts-ignore
    var __VLS_57 = __VLS_asFunctionalComponent(__VLS_56, new __VLS_56(__assign({ icon: "fa-solid fa-circle-info" }, { class: "mr-1" })));
    var __VLS_58 = __VLS_57.apply(void 0, __spreadArray([__assign({ icon: "fa-solid fa-circle-info" }, { class: "mr-1" })], __VLS_functionalComponentArgsRest(__VLS_57), false));
    (__VLS_ctx.$t('hailuo.name.failureReason'));
    ...
    /** @type {[typeof __VLS_components.FontAwesomeIcon, typeof __VLS_components.fontAwesomeIcon, ]} */ ;
    // @ts-ignore
    var __VLS_65 = __VLS_asFunctionalComponent(__VLS_64, new __VLS_64(__assign({ icon: "fa-solid fa-hashtag" }, { class: "mr-1" })));
    var __VLS_66 = __VLS_65.apply(void 0, __spreadArray([__assign({ icon: "fa-solid fa-hashtag" }, { class: "mr-1" })], __VLS_functionalComponentArgsRest(__VLS_65), false));
    (__VLS_ctx.$t('hailuo.name.traceId'));
...
if (((_21 = (_20 = __VLS_ctx.modelValue) === null || _20 === void 0 ? void 0 : _20.response) === null || _21 === void 0 ? void 0 : _21.success) === undefined) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ({ content: true }) }));
    var __VLS_72 = {}.ElAlert;
    /** @type {[typeof __VLS_components.ElAlert, typeof __VLS_components.elAlert, typeof __VLS_components.ElAlert, typeof __VLS_components.elAlert, ]} */ ;
    // @ts-ignore
    var __VLS_73 = __VLS_asFunctionalComponent(__VLS_72, new __VLS_72(__assign({ closable: (false) }, { class: "info" })));
    var __VLS_74 = __VLS_73.apply(void 0, __spreadArray([__assign({ closable: (false) }, { class: "info" })], __VLS_functionalComponentArgsRest(__VLS_73), false));
    __VLS_75.slots.default;
    {
        var __VLS_thisSlot = __VLS_75.slots.template;
        var __VLS_76 = {}.FontAwesomeIcon;
        /** @type {[typeof __VLS_components.FontAwesomeIcon, typeof __VLS_components.fontAwesomeIcon, ]} */ ;
        // @ts-ignore
        var __VLS_77 = __VLS_asFunctionalComponent(__VLS_76, new __VLS_76(__assign({ icon: "fa-solid fa-exclamation-triangle" }, { class: "mr-1" })));
        var __VLS_78 = __VLS_77.apply(void 0, __spreadArray([__assign({ icon: "fa-solid fa-exclamation-triangle" }, { class: "mr-1" })], __VLS_functionalComponentArgsRest(__VLS_77), false));
        (__VLS_ctx.$t('hailuo.name.failure'));
    }
    __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)(__assign({ class: "text-[var(--el-text-color-regular)] text-xs mb-0" }));
    ...
    (__VLS_ctx.$t('hailuo.name.taskId'));
    ((_22 = __VLS_ctx.modelValue) === null || _22 === void 0 ? void 0 : _22.id);
    var __VLS_84 = {}.CopyToClipboard;
    /** @type {[typeof __VLS_components.CopyToClipboard, typeof __VLS_components.copyToClipboard, ]} */ ;
    // @ts-ignore
    var __VLS_85 = __VLS_asFunctionalComponent(__VLS_84, new __VLS_84({
        content: ((_23 = __VLS_ctx.modelValue) === null || _23 === void 0 ? void 0 : _23.id),
    }));
